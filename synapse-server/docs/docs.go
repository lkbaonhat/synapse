...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_synapse_server_internal_domain.Card"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_synapse_server_internal_domain.Deck"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createDeckRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createCardRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/decks/{id}/import": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "CSV File (format: front,back)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_synapse_server_internal_domain.DeckStats"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.attachTagsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/export": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "synapse_export.json",
                        "schema": {
                            "type": "file"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_synapse_server_internal_domain.Folder"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createFolderRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.updateFolderRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_synapse_server_internal_domain.DailyActivity"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_synapse_server_internal_domain.ForecastDay"
                            }
                        }
                    },
                    "401": {
        ...
        "/stats/overview": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Total cards in library",
                        "name": "totalCards",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_synapse_server_internal_domain.StatsOverview"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.startSessionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.answerRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_synapse_server_internal_domain.QuizResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_synapse_server_internal_domain.Tag"
                            }
                        }
                    },
                    "401": {
    ...
    "definitions": {
        "github_com_synapse_server_internal_domain.Card": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
                ...
                "dueAt": {
                    "description": "nil → card not yet studied (new)",
                    "type": "string"
                },
                "easiness": {
                    "description": "SM-2 E-factor (default 2.5)",
                    "type": "number",
                    "format": "float64"
                },
                "id": {
                ...
                "interval": {
                    "description": "SRS scheduling fields (initialised on first study)",
                    "type": "integer"
                },
                "repetitions": {
                    "description": "total successful reviews",
                    "type": "integer"
                },
                "tags": {
                    "type": "array",
                ...
                "type": {
                    "$ref": "#/definitions/github_com_synapse_server_internal_domain.CardType"
                },
                "updatedAt": {
                    "type": "string"
                }
        ...
        "github_com_synapse_server_internal_domain.CardType": {
            "type": "string",
            "enum": [
                "flashcard",
                "cloze",
            ...
            "x-enum-varnames": [
                "CardTypeFlashcard",
                "CardTypeCloze",
                "CardTypeFreeResponse",
                "CardTypeMultipleChoice"
            ]
        },
        "github_com_synapse_server_internal_domain.DailyActivity": {
            "description": "A data-point representing learning activity for a specific day",
            "type": "object",
            "properties": {
                "count": {
                    "description": "cards reviewed that day",
                    "type": "integer"
                },
                "date": {
        ...
        "github_com_synapse_server_internal_domain.Deck": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_synapse_server_internal_domain.DeckStats": {
        ...
        "github_com_synapse_server_internal_domain.Folder": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_synapse_server_internal_domain.ForecastDay": {
        ...
        "github_com_synapse_server_internal_domain.QuizResult": {
            "type": "object",
            "properties": {
                "totalCorrect": {
                    "type": "integer"
                ...
                "wrongAnswers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_synapse_server_internal_domain.WrongAnswerSummary"
                    }
                }
            }
        },
        "github_com_synapse_server_internal_domain.StatsOverview": {
        ...
        "github_com_synapse_server_internal_domain.StudyMode": {
            "type": "string",
            "enum": [
                "learn",
                "review",
        ...
        "github_com_synapse_server_internal_domain.Tag": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_synapse_server_internal_domain.WrongAnswerSummary": {
            "type": "object",
            "properties": {
                "cardId": {
                    "type": "string"
        ...
        "internal_handler.answerRequest": {
            "type": "object",
            "required": [
                "cardId",
                "rating",
        ...
        "internal_handler.attachTagsRequest": {
            "type": "object",
            "required": [
                "tagIds"
            ],
        ...
        "internal_handler.createCardRequest": {
            "type": "object",
            "required": [
                "content",
                "type"
        ...
        "internal_handler.createDeckRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_handler.createFolderRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_handler.startSessionRequest": {
            "type": "object",
            "required": [
                "deckId",
                "mode"
            ...
            "properties": {
                ...
                "mode": {
                    "$ref": "#/definitions/github_com_synapse_server_internal_domain.StudyMode"
                }
            }
        },
        "internal_handler.updateFolderRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
